...
cp.insertClassPath(Paths.get(basedir, "target", "classes").toAbsolutePath().toString())
...
def fixedPartd = parser.parse(Paths.get(basedir, "xsdgen", "base.xsd").toFile())
...
Files.write(Paths.get(basedir, "target", "classes", "fakerpp.xsd"),
