...
public class ListContentUnsafeBinder implements ListChangeListener, WeakListener {
    private final WeakReference<List> listRef;

    public ListContentUnsafeBinder(List list) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListContentUnsafeBinder) {
            final ListContentUnsafeBinder other = (ListContentUnsafeBinder) obj;
